...
\begin{eqnarray*}
  ...
  \alpha_c = {\color{purple}\frac{1}{1 - \phi}} \frac{\partial \phi}{\partial p}.
\end{eqnarray*}
...
\begin{equation}
  ...
  \label{eq-sto}
\end{equation}
The specific storage \footnote{{\color{purple}It should be noted that the assumptions underlying the specific storage formulation don't necessarily hold in the unsaturated case, but the error from including it is generally small; see, for example, the SUTRA manual.}} in this equation is defined as
\begin{equation}
  S_s = \rho g {\color{purple}\left[ \phi \beta_c + (1 - \phi) \alpha_c \right]}.
  \label{eq-spec-sto}
\end{equation}
