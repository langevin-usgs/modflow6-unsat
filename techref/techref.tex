...
Picard iteration method, or by applying the Newton-Raphson 
...
domain. For every outer iteration, the linearized system is solved by 
the MODFLOW iterative solver as part.
